"""
    ...
    Code Plucked from : https://github.com/coveooss/SIGIR-ecom-data-challenge/blob/main/start/dataset_stats.py
"""
...
BROWSING_FILE_PATH = './SIGIR-ecom-data-challenge/train/browsing_train.csv'
SEARCH_TRAIN_PATH = './SIGIR-ecom-data-challenge/train/search_train.csv'
SKU_2_CONTENT_PATH = './SIGIR-ecom-data-challenge/train/sku_to_content.csv'
